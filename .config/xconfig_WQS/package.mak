...
ti.targets.arm.elf.M4F.rootDir ?= C:/ti/ccsv6/tools/compiler/ti-cgt-arm_16.9.3.LTS
...
package/%.xdc.inc package/%_xconfig_WQS.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_WQS" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: WQS.pem4f

-include package/cfg/WQS_pem4f.mak
-include package/cfg/WQS_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/WQS_pem4f.dep
endif
WQS.pem4f: package/cfg/WQS_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
WQS.pem4f package/cfg/WQS_pem4f.c: .libraries,em4f
endif

package/cfg/WQS_pem4f.c package/cfg/WQS_pem4f.h package/cfg/WQS_pem4f.xdl: override _PROG_NAME := WQS.xem4f
package/cfg/WQS_pem4f.c: package/cfg/WQS_pem4f.cfg
package/cfg/WQS_pem4f.xdc.inc: package/cfg/WQS_pem4f.xdl
package/cfg/WQS_pem4f.xdl package/cfg/WQS_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/WQS_pem4f.cfg
	-$(RM) package/cfg/WQS_pem4f.dep
	-$(RM) package/cfg/WQS_pem4f.c
	-$(RM) package/cfg/WQS_pem4f.xdc.inc

clean,em4f::
	-$(RM) WQS.pem4f
.executables,em4f .executables: WQS.xem4f

WQS.xem4f: |WQS.pem4f

-include package/cfg/WQS.xem4f.mak
WQS.xem4f: package/cfg/WQS_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/WQS_pem4f.oem4f   package/cfg/WQS_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
WQS.xem4f: export C_DIR=
WQS.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
WQS.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

WQS.test test,em4f test: WQS.xem4f.test

WQS.xem4f.test:: WQS.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 WQS.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.WQS.xem4f, ) 
endif
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
WQS_pem4f.oem4f,copy : package/cfg/WQS_pem4f.oem4f
WQS_pem4f.sem4f,copy : package/cfg/WQS_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_WQS
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_WQS.tar.dep
endif
package/rel/xconfig_WQS/xconfig_WQS/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_WQS/xconfig_WQS/package/package.rel.xml: package/build.cfg
package/rel/xconfig_WQS/xconfig_WQS/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_WQS/xconfig_WQS/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_WQS.tar: package/rel/xconfig_WQS.xdc.inc package/rel/xconfig_WQS/xconfig_WQS/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_WQS.xdc.inc,package/rel/xconfig_WQS.tar.dep)


release release,xconfig_WQS: all xconfig_WQS.tar
clean:: .clean
	-$(RM) xconfig_WQS.tar
	-$(RM) package/rel/xconfig_WQS.xdc.inc
	-$(RM) package/rel/xconfig_WQS.tar.dep
